...
import cute.ame.pioneer.Core.Render.Cache.LUTManager;
...
public final class LUTRegistry
{
    ...
    public static void register(ResourceLocation id, LUTBaker baker)
    {
        ...
        if (existing != null) Pioneer.LOGGER.warn("[Auralith] LUT baker '{}' registered twice — keeping the first registration", id);
    }
