...
public final class GPUProfiler
{
    ...
    static
    {
        if (DEBUG) Auralithpioneerinitiative.LOGGER.info("[Auralith] GPUProfiler active (DEBUG=true)");
    }
    ...
    public static void endFrame()
    {
        ...
        if (active != null)
        {
            Auralithpioneerinitiative.LOGGER.warn("[Auralith] GPUProfiler: section '{}' left open at endFrame()", active);
            activeSection = null;
            activeSlot = -1;
            active = null;
        }
