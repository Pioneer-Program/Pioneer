...
public final class SeamlessGhostSurfacePatchRenderer
{
    ...
    public static void renderPatch(PoseStack ps, PlanetDefinition planet, float camLX, float camLY, float camLZ)
    {
        ...
        Auralithpioneerinitiative.LOGGER.debug("[Auralith] Surface patch for {}: anchor={} surfaceY={} nearestFaceNormal=({},{},{}) sections={}", dimension.location(), anchor.toShortString(), surfaceY, face.normal().x, face.normal().y, face.normal().z, sections.size());
